...
Materialet er beregnet på to undervisningsganger, med to arbeidsøkter på omtrent 45 minutter hver.

## Arbeidsøkt 1: Rekursjonsformler fra problemer

I denne arbeidsøkten skal vi undersøke hvordan en følge av tall kan beskrives ved hjelp av tidligere tall i følgen.

Vi skal særlig arbeide med to spørsmål:

1. Hvordan kan en rekursjonsformel oppstå fra et konkret problem?
2. Hvordan kan kunstig intelligens brukes til å finne, forklare og kontrollere matematiske argumenter?
...
Ta pause før du går videre til eksplisitte formler.
:::

## Arbeidsøkt 2: Fra rekursjonsformel til eksplisitt formel

Vi skal nå undersøke hvordan vi kan gå fra en rekursjonsformel til en formel for det $n$-te leddet.
...
Etter de to første arbeidsøktene bør du kunne gå begge veier i diagrammet
...
Når du bruker KI i matematikk, er det ikke nok at svaret ser overbevisende ut. I disse arbeidsøktene har du blant annet brukt tre måter å kontrollere KI på:
...
## Arbeidsøkt 3: Genererende funksjoner

I de to første arbeidsøktene brukte vi rekursjonsformler til å beskrive følger og den karakteristiske ligningen til å finne eksplisitte formler. Nå skal vi møte et nytt verktøy: **genererende funksjoner**.
...
Vi bruker samme nummerering som i de første arbeidsøktene:
...
Be deretter KI om å faktorisere nevneren og gjøre en delbrøkoppspalting. Les av koeffisienten til $x^n$ og sammenlign den eksplisitte formelen med den dere fant i arbeidsøkt 2.
...
## Arbeidsøkt 4: Derangements og Catalan-tall

I denne arbeidsøkten bruker vi rekursjonsformler og genererende funksjoner på to nye telleproblemer.
...
### Oppsummering av arbeidsøkt 4

I de to siste arbeidsøktene har vi brukt genererende funksjoner som et algebraisk språk for følger:
